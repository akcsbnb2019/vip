                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-content-inner">
                            <div class="row">
                                <div class="col-50 tt-style-score" style="border-right:1px solid #e1e1e1;">本期积分</div>
                                <div class="col-50 tt-style-score"><?php if($model['allfx']['zong']>=300){echo substr(sprintf("%.5f",$total['bonus'] ),0,-1)-substr(sprintf("%.5f",$total['declaration']*0.92),0,-1)
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-content-inner">
                            <div class="row">
                                <div class="col-50 tt-style-score" style="border-right:1px solid #e1e1e1;">本期积分</div>
                                <div class="col-50 tt-style-score"><?=$total['declaration']*0.92?></div>
                            </div>
                        </div>
                    </div>
                </div>

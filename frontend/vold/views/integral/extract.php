...
<div class="cents">
    ...
    <?php $form = ActiveForm::begin(['id' => 'extract-form','action' => '/integral/confextract']); ?>
    <div class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <label class="layui-form-label">直接兑换</label>
...
<script>
    ...
    function checkmoney(obj,amount) {
        ...
        if(isMoney!=0){
            $("#amount").focus();
            $("#msg_amount").html("<span class='red'>提现金额为50的倍数</span>");
            return false;
        }else{
            if(money>amount){
                $("#amount").focus();
                $("#msg_amount").html("<span class='red'>提现金额不能大于当前余额</span>");
                return false;
            }else{
                $("#msg_amount").html("");
            }
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        //监听提交
        $('#extract-form').bind('submit', function(){

...
<div class="text-center">
	<br><br><h3>请完善代理商后操作</h3><br><button type="button" class="btn btn-primary btn-info btno" data-toggle="modal" data-target="#myModal5" id="passk">开始验证代理商</button>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br><br><div style="color: red; float:right;">如转账通过同团队服务中心,请点击此处<a href="?type=1">完善服务中心</a></div><br>
                <?php ActiveForm::end(); ?>
                </p>
            </div>
        </div>

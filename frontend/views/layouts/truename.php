...
<div class="text-center">
	<br><br><h3>请完善昵称后操作</h3><br><button type="button" class="btn btn-primary btn-info btno" data-toggle="modal" data-target="#myModal5" id="passk">开始验证二级密码</button>
</div>

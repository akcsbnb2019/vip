                    ...
                    <div class="row">  
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #ddd;text-align: center">本期积分-(<a href="<?= Url::to('/integral/detailslist2?scount='.$total['scount'].'&type=1'); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #1ab394; text-align: center">本期积分-(<a href="<?= Url::to('/integral/detailslist2?scount='.$total['scount'].'&type=2'); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6;text-align: center">本期积分-(<a href="<?= Url::to('/integral/detailslist2?scount='.$total['scount'].'&type=3'); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分-(<a href="<?= Url::to('/integral/detailslist2?scount='.$total['scount'].'&type=4'); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分-(<a href="<?= Url::to('/integral/detailslist2?scount='.$total['scount'].'&type=5'); ?>">详情</a>)</div>

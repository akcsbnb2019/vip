                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分</div>
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?php if($model['allfx']['zong']>=300){echo substr(sprintf("%.5f",$total['bonus'] ),0,-1)-substr(sprintf("%.5f",$total['declaration']*0.92),0,-1)
	                                    ...
	                                    -(isset($model['allgl']['zong'])?substr(sprintf("%.5f",$model['allgl']['zong']),0,-1):0)
	                                    -(isset($model['alljb']['zong'])?substr(sprintf("%.5f",$model['alljb']['zong']),0,-1):0)
	                                    -(isset($model['alljc']['zong'])?substr(sprintf("%.5f",$model['alljc']['zong']),0,-1):0);}else{echo 0;}?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分</div>
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?=$total['declaration']*0.92?></div>
                                </div>
                            </div>
                        </div>
                        <?php endif;?>

                    ...
                    <table class="table table-hover d-border" id="tables">
                        <thead>
                            <tr>
                                ...
                                <button type="button" class="btn btn-outline btn-primary righo" id="funin">返回兑换</button>
                                <?php } ?>
                                </th>
                            </tr>
                        </thead>
                        ...
                        <?php foreach($model as $key=>$val){?>
                            <tr>
                                ...
                                <td><?=$val['addtimes']; ?></td>
                                <td><?=$val['memo']; ?></td>
                                <td class="text-navy" colspan="2"><?php if($val['states']=="1") {echo '已处理';} else if($val['states']=="8") {echo '自动处理';} else {echo '未处理';}?></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>

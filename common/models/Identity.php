...
//        }
        ...
        if(strlen($this->dateNum) == 8){
            $date1 = intval(substr($this->dateNum,0,4));
            $date2 = intval(substr($this->dateNum,4,2));
            $date3 = intval(substr($this->dateNum,6,2));
        }else{
            $date1 = intval('19'.substr($this->dateNum,0,2));
            $date2 = intval(substr($this->dateNum,2,2));
            $date3 = intval(substr($this->dateNum,4,2));
        }
        ...
        if(isset($date2)){
            ...
            if($Yc == $smY){
                if($idate2 > $date2){
                    return true;
                }else if($idate2 == $date2 && isset($date3) && $idate3 >= $date3){
                    return true;
                }
            }else{
                if($idate2 < $date2){

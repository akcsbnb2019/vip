var navtab;
layui.config({
    base: '../pc/js/lib/' //layui自定义layui组件目录
}).extend({
    larry: 'larry',
    navtab: 'navtab',
    elemnts: 'elements',
...
layui.use(['elements', 'jquery', 'layer', 'larry', 'navtab', 'form', 'common'], function () {
    ...
    $(document).ready(function () {
        ...
        $.getJSON('../pc/datas/top_menu.json?t=' + new Date(), {
            Param: 'index_menu'
        }, function (result) {
            larry.set({
                elem: '#menu',
        ...
        $menu.find('li.layui-nav-item').each(function () {
            ...
            $that.on('click', function () {
                ...
                $.getJSON('../pc/datas/pid_' + id + '.json?t=' + new Date(), {
                    pid: id,
                    Param: 'index_menu'
                }, function (result) {
                    larry.set({

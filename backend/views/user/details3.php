			...
			<div class="ibox">
                    ...
                    <div class="row">  
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #ddd;text-align: center">本期积分-(<a href="<?= Url::to('/user/detailslist2?scount='.$total['scount'].'&type=1&id='.$id); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #1ab394; text-align: center">本期积分-(<a href="<?= Url::to('/user/detailslist2?scount='.$total['scount'].'&type=2&id='.$id); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
								...
								<div class="row">
									<div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6;text-align: center">本期积分-(<a href="<?= Url::to('/user/detailslist2?scount='.$total['scount'].'&type=3&id='.$id); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分-(<a href="<?= Url::to('/user/detailslist2?scount='.$total['scount'].'&type=4&id='.$id); ?>">详情</a>)</div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6; text-align: center">本期积分-(<a href="<?= Url::to('/user/detailslist2?scount='.$total['scount'].'&type=5&id='.$id); ?>">详情</a>)</div>
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?=$model['alljc']['zong1']?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?php if($model['allfx']['zong']>=300){echo substr(sprintf("%.5f",substr(sprintf("%.5f",$total['tdgjj'] ),0,-1)
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="panel-heading tt-t-a-c"><strong class="center-block" style="color:#4ab624; text-align: center">FXQ</strong></div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?=$model['allfx']['zong']?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                <div class="panel-heading tt-t-a-c"><strong class="center-block" style="color:#0bc2d2; text-align: center">扣税</strong></div>
                                <div class="row">
                                    <div class="col-sm-6 tt-style-score" style="border-right:1px solid #1c84c6;text-align: center">本期积分</div>
                                    <div class="col-sm-6 tt-style-score" style="text-align: center"><?=$shui?></div>
                                </div>
                            </div>
                        </div>
                    </div>

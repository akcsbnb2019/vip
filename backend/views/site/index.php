...
?>
	...
	<link rel="stylesheet" type="text/css" href="/common/font_bmgv5kod196q1tt9.css">
	<link rel="stylesheet" type="text/css" href="/pc/css/backstage.css" media="all">
</head>
<body>
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side larrycms-left" id="larry-side">
		 <div class="layui-side-scroll" >
              ...
              <div class="user-info">
                   <div class="photo">
                       <img src="/pc/images/user.jpg" alt="">
                   </div>
                   <p><?= Yii::$app->session->get('uname'); ?>您好！欢迎登录</p>
              </div>
              <!-- 系统菜单 -->
        ...
        <div class="layui-tab" id="larry-tab" lay-filter="larryTab">
             ...
             <div class="layui-tab-content">
                  <div class="layui-tab-item layui-show">
                      <iframe class="larry-iframe" data-id='0' name="ifr_0" id='ifr0' src="/site/main"></iframe>
                  </div>
             </div>
        </div>
    </div>
    ...
    <div class="layui-footer layui-larry-foot psob" id="larry-footer">
    	   <div class="layui-main">
               <p>2016-2017 © Write by KML. 版权所有</p> 
         </div>
    </div>
    <!-- footer end -->
...
<script type="text/javascript">
    var nav1 = <?=(isset($nav->i1)?$nav->i1->children:'[]');?>;
    var nav2 = <?=(isset($nav->i2)?$nav->i2->children:'[]');?>;
    var nav3 = <?=(isset($nav->i3)?$nav->i3->children:'[]');?>;
</script> 
<script type="text/javascript" src="/common/layui/layui.js"></script> 
<script type="text/javascript" src="/pc/js/larrycms.js"></script>
<!-- 主题配置 -->
            ...
            <div class="layui-form-item select-theme">
                ...
                <div class="layui-input-block">
                    <select lay-filter="larryTheme"  lay-verify="" id="themeName">
                      ...
                      <option value="larry_">更多主题</option>
                    </select>     
                </div>
            </div>
